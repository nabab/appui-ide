    ...
    methods: {
      ...
      abortRequest(a){
        ...
        if ( a === 'dir' ){
          ...
          bbn.fn.abort(appui.plugins['appui-ide'] + '/actions/finder2/file')
        }
        this.currentFile = false;
      },
      ...
      delete(node){
        ...
        this.confirm(bbn._('Do you want to delete') + ' ' + node.data.value + '?', () => {
          //CAPIRE CHE METTERE COME MODE
          let st = ( (this.mode === 'ftp') || (this.mode === 'ssh')) ? this.source.origin + this.currentPath : this.currentPath,
