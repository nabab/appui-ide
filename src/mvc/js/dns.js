    ...
    methods: {
      ...
      dns_get_record() {
        if (this.hostname.dns_get_record) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {hostname: this.hostname.dns_get_record, method: 'dns_get_record'}, d => {
      ...
      checkdnsrr() {
        if (this.hostname.checkdnsrr) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {hostname: this.hostname.checkdnsrr, type: this.type, method: 'checkdnsrr'}, d => {
      ...
      gethostbyname() {
        if (this.hostname.gethostbyname) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {hostname: this.hostname.gethostbyname, method: 'gethostbyname'}, d => {
      ...
      gethostbynamel() {
        if (this.hostname.gethostbynamel) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {hostname: this.hostname.gethostbynamel, method: 'gethostbynamel'}, d => {
      ...
      gethostname() {
        bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {method: 'gethostname'}, d => {
      ...
      gethostbyaddr() {
        if (this.ipAdr.gethostbyaddr) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {ip: this.ipAdr.gethostbyaddr, method: 'gethostbyaddr'}, d => {
      ...
      ip2long() {
        if (this.ipAdr.ip2long) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {ip: this.ipAdr.ip2long, method: 'ip2long'}, d => {
      ...
      long2ip() {
        if (this.ipAdr.long2ip) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {ip: this.ipAdr.long2ip, method: 'long2ip'}, d => {
      ...
      checkportopen() {
        if (this.checkport.hostname && this.checkport.port) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {hostname: this.checkport.hostname, port: this.checkport.port, method: 'checkportopen'}, d => {
      ...
      getservbyport() {
        if (this.port) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {port: this.port, protocol: this.protocol, method: 'getservbyport'}, d => {
      ...
      netgetinterfaces() {
        bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {method: 'net_get_interfaces'}, d => {
      ...
      getprotobyname() {
        if (this.protocol) {
          bbn.fn.post(appui.plugins['appui-newide'] + '/dns', {protocol: this.protocol, method: 'getprotobyname'}, d => {
