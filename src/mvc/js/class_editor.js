...
(() => {
  return {
    ...
    methods: {
      ...
      makeEnv() {
        this.isLoading = true;
        bbn.fn.post(appui.plugins['appui-newide'] + '/data/lib_install', {class: this.currentClass, lib: this.currentLibrary, root: this.libRoot}, d => {
          this.alertResult(d);
      ...
      delEnv() {
        this.isLoading = true;
        bbn.fn.post(appui.plugins['appui-newide'] + '/data/delete_install', {lib: this.currentLibrary, root: this.libRoot}, d => {
          if (d.success) {
            this.libInstalled = false;
            this.tests_info = {};
            this.isLoading = false;
      ...
      addClass() {
        this.getPopup({
          component: 'appui-newide-cls-new',
          source: {
      ...
      loadClass()
      {
        ...
        return new Promise(resolve => {
          bbn.fn.post(appui.plugins['appui-newide'] + '/class_editor', {class: this.currentClass, lib: this.currentLibrary, root: this.libRoot}, d => {
            this.data = d.data;
            bbn.fn.post(appui.plugins['appui-newide'] + '/data/check_install', {lib: this.currentLibrary, root: this.libRoot}, d => {
