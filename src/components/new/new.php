...
>
  <div class="bbn-padded">
    ...
    <div class="bbn-form-field mvc-ele" v-if="isMVC">
      <bbn-dropdown  ref="types" :source="types" v-model="selectedType" name="tab" required="required"></bbn-dropdown>
    </div>
    <div class="bbn-form-label"><?=_("Name")?></div>
    <div class="bbn-form-field">
      <bbn-input type="text" name="name" v-model="name"  required="required"></bbn-input>
    ...
    <div class="bbn-form-field">
      <bbn-input  type="text" name="path" v-model="path" readonly="readonly" required="required"></bbn-input>
  ...
  <div slot="footer">
    <bbn-button icon="fas fa-check" type="submit"><?=_("Save")?></bbn-button>
