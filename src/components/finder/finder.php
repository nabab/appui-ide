  ...
  <bbn-scroll v-else axis="x" :class="componentClass" ref="scroll">
    ...
    <div v-if="preview && currentFile"
      ...
      <div class="bbn-grid-fields bbn-header bbn-widget bbn-spadded">
        ...
        <span v-if="currentFile.info && currentFile.info.size" v-text="_('Size')"/>
        <span v-text="(currentFile.info && currentFile.info.size) ? currentFile.info.size : ''"/>
        <span v-if="(currentFile.info && currentFile.info.width)" v-text="_('Width')"/>
        <span v-if="(currentFile.info && currentFile.info.width)" v-text="currentFile.info.width + 'px'"/>
        <span v-if="(currentFile.info && currentFile.info.height)" v-text="_('Height')"/>
        <span v-if="(currentFile.info && currentFile.info.height)" v-text="currentFile.info.height + 'px'"/>
