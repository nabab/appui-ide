...
(function ($installer) {
  ...
  //die(json_encode(['currentPath' => getcwd()]));
    ...
    switch($operation) {
      ...
      case 'getLibraryClasses':
        if (isset(
          ...
          include_once('vendor/autoload.php');
          $parser = new bbn\Parsers\Php();
          //die(var_dump("JJJ", file_get_contents('vendor/autoload.php'), $params['dir']));
          $library = [];
          $fullpath = $params['fullpath'];
          $psr_infos = $params['psr_infos'];
        ...
        break;
      case 'analyzeTestClass':
        if (isset($params['dir'], $params['testdir'], $params['testclass'])) {
          include_once $params['dir'] . '/vendor/autoload.php';
          $parser = new bbn\Parsers\Php();
          include_once $params['testdir'] . 'autoload.php';
          $data = $parser->analyzeClass($params['testclass']);
          $data['loc'] = getcwd();
          die(json_encode($data));
        }
        break;
